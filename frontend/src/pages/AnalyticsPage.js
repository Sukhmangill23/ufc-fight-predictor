...
const FighterAnalyticsPage = () => {
  ...
  return (
      <div
          className="d-flex justify-content-center py-4 fighter-analytics-container">
        <div
        ...
        >
          <div className="card-header bg-dark">
            ...
            <p className="mb-0 text-light">Detailed performance statistics for
              UFC fighters</p>
          </div>
          ...
          <div className="card-body fighter-card-body">
                      ...
                      <div className="fighter-header text-center p-4">
                        ...
                        <div className="d-flex justify-content-center mt-3">
                          <div className="stat-badge me-3">
                            <div
                                className="stat-value">{fighterData.basic_stats.height || 'N/A'} cm
                            </div>
                            <div className="stat-label">Height</div>
                          </div>
                          <div className="stat-badge me-3">
                            <div
                                className="stat-value">{fighterData.basic_stats.reach || 'N/A'} cm
                            </div>
                            <div className="stat-label">Reach</div>
                          </div>
                          <div className="stat-badge me-3">
                            <div
                                className="stat-value">{fighterData.basic_stats.age || 'N/A'}</div>
                            <div className="stat-label">Age</div>
                          </div>
                          <div className="stat-badge">
                            <div
                                className="stat-value">{fighterData.basic_stats.weight_class || 'N/A'}</div>
                      ...
                      <div className="card">
                        ...
                        <div className="card-body">
                          <div className="table-responsive">
                            <table
                                className="table table-dark table-striped fight-table">
                              <thead>
                              <tr>
                                <th>Date</th>
                                <th>Opponent</th>
            ...
            {!fighterData && !loading && (
                <div className="text-center py-5 empty-state">
                  ...
                  <p>
                    Enter a fighter's name to view detailed performance
                    analytics and fight history
                  </p>
                </div>
            )}
          </div>
