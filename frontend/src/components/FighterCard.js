              ...
              <>
                  ...
                  <div className="stats-grid">
                      <div className="stat-card">
                          <div
                              className="stat-value">{stats.height || 'N/A'} cm
                          </div>
                          <div className="stat-label">Height</div>
                      </div>
                      <div className="stat-card">
                          <div
                              className="stat-value">{stats.reach || 'N/A'} cm
                          </div>
                      ...
                      <div className="stat-card">
                          <div
                              className="stat-value">{stats.stance || 'N/A'}</div>
                          <div className="stat-label">Stance</div>
                      </div>
                      <div className="stat-card">
                          <div
                              className="stat-value">{stats.win_streak || '0'}</div>
                          <div className="stat-label">Win Streak</div>
                      </div>
                      <div className="stat-card">
                          <div
                              className="stat-value">{stats.ko_wins || '0'}</div>
